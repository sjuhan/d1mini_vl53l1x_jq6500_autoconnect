...
unsigned long current_time, past_time = 0;
...
TEMP_HUMI get_Temp_Humi()
{
  ...
  if (current_time - past_time > 1000)
  {
    ...
    {
      aht_res.temperature = myAHT10.readTemperature(AHT10_USE_READ_DATA);
      aht_res.humidity = myAHT10.readHumidity(AHT10_USE_READ_DATA);
      /* 
      Serial.print(F("Temperature: "));
      Serial.print(aht_res.temperature);
      Serial.println(F(" +-0.3C"));
      Serial.print(F("Humidity...: "));
      Serial.print(aht_res.humidity);
      Serial.println(F(" +-2%")); */
    }
    else
    {
...
void setup(void)
{
  ...
  httpUpdater.setup(&webServer, USERNAME, PASSWORD);
...
void loop(void)
{
  ...
  get_Temp_Humi();
  if (aht_res.updated==true){
    Serial.print("기온:");
    Serial.println(aht_res.temperature);
    Serial.print("습도:");
    Serial.println(aht_res.humidity);
    Serial.println("--------");
    aht_res.updated=false;
  }
}
